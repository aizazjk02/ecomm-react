        ...
        <div className="checkout__item__container">
            ...
            <div className="details">
                ...
                <span className="quantity">
                    <div className="arrow" onClick={() => dispatch(removeProductFromCart(cartItem))}>&#10094;</div>
                    <span className="value">
                        {quantity}
                    </span>
                    <div className="arrow" onClick={() => dispatch(addProductToCart(cartItem))}>&#10095;</div>
                </span>
                <p>Price</p>
                <span className="price">${price}</span>
                <button onClick={() => dispatch(clearProductFromCart(cartItem))}>remove</button>
            </div>
        </div>
    )
}
