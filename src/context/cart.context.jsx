...
export const CartProvider = ({ children }) => {
    ...
    const providerValues = { clearCart,isCartOpen, setIsCartOpen, addProductToCart, removeProductFromCart, clearProductFromCart, cartItems, cartItemsCount, cartTotal }
